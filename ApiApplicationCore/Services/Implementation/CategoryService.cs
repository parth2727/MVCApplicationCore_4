    ...
    public class CategoryService : ICategoryService
    {
        ...
        public ServiceResponse<IEnumerable<CategoryDto>> GetCategories()
        {
            ...
            if (categories != null || categories.Any())
            {
                ...
                {
                    categoriesDto.Add(new CategoryDto() { CategoryId = category.CategoryId, CategoryName = category.Name, CategoryDescription = category.Description });
                }
        ...
        public ServiceResponse<CategoryDto> GetCateory (int categoryId)
        {
